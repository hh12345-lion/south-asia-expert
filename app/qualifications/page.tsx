  ...
  return (
    <>
      ...
      <PageShell title="South Asia Expert Witness Qualifications UK" breadcrumbs={crumbs}>
        <h2 className="text-xl font-bold text-[#0E2433]">What Makes a Qualified South Asia Expert</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">Key Qualifications for South Asia Experts</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">Neutrality Across Countries and Profiles</h2>
        <p className="mt-4 text-[#2C3A45] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">Red Flags</h2>
        <ul className="mt-4 list-disc space-y-2 pl-6 text-[#2C3A45]">
