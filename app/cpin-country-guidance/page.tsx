  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">Current South Asia CPINs</h2>
        <div className="mt-4">
          <ResponsiveTableWrap>
            <table className="w-full min-w-[500px] border-collapse text-sm">
              <caption className="mb-3 text-left text-base font-semibold text-[#0E2433]">
              ...
              <thead>
                <tr className="border-b border-[#C5D0D8] bg-[#DCE5EA]">
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-[#0E2433]">CPIN Topics Available</th>
                </tr>
              </thead>
              <tbody>
                {cpinRows.map((row) => (
                  <tr key={row.country} className="border-b border-[#C5D0D8]">
                    <td className="px-4 py-3 font-medium text-[#2C3A45]">{row.country}</td>
                    <td className="px-4 py-3 text-[#2C3A45]">{row.topics}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <p className="mt-4 text-sm text-[#2C3A45] italic">{cpinNote}</p>

        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">Country Guidance Cases</h2>
        <ul className="mt-4 space-y-4">
          {countryGuidanceCases.map((cg) => (
            <li key={cg.citation} className="rounded-none border border-[#C5D0D8] bg-[#DCE5EA] p-4">
              <p className="font-semibold text-[#0E2433]">{cg.citation}</p>
              <p className="mt-1 text-sm text-[#2C3A45]">{cg.summary}</p>
            </li>
          ))}
        </ul>
        <p className="mt-4 text-[#2C3A45]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">Post-August 2024 Bangladesh CPIN Gap</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0E2433]">How Expert Reports Relate to CPINs</h2>
        <p className="mt-4 text-[#2C3A45] leading-relaxed">
