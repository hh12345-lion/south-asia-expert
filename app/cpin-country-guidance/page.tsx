  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">Current South Asia CPINs</h2>
        <div className="mt-4">
          <ResponsiveTableWrap>
            <table className="w-full min-w-[500px] border-collapse text-sm">
              <caption className="mb-3 text-left text-base font-semibold text-[#1C2541]">
              ...
              <thead>
                <tr className="border-b border-[#D8D4CC] bg-[#EBE6DC]">
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-[#1C2541]">CPIN Topics Available</th>
                </tr>
              </thead>
              <tbody>
                {cpinRows.map((row) => (
                  <tr key={row.country} className="border-b border-[#D8D4CC]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">Country Guidance Cases</h2>
        <ul className="mt-4 space-y-4">
          {countryGuidanceCases.map((cg) => (
            <li key={cg.citation} className="rounded-none border border-[#D8D4CC] bg-[#EBE6DC] p-4">
              <p className="font-semibold text-[#1C2541]">{cg.citation}</p>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">Post-August 2024 Bangladesh CPIN Gap</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">How Expert Reports Relate to CPINs</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
