...
export const metadata = createMetadata({
  title: "Cookie Policy",
  description:
    "How South Asia Expert.com uses cookies and similar technologies, your choices under GDPR and ePrivacy, and how to manage preferences.",
  path: "/cookie-policy",
});
    ...
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: June 2026" breadcrumbs={crumbs}>
        <p className="text-[#3A4250] leading-relaxed">
          This Cookie Policy explains how South Asia Expert.com (&quot;we&quot;, &quot;us&quot;) uses
          cookies and similar technologies when you visit our website. It should be read alongside
          our{" "}
          <Link href="/privacy" className="font-semibold text-[#716148] hover:underline">
            Privacy Policy
          </Link>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Google Consent Mode</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Cookie categories</h2>
        <div className="mt-4 space-y-4">
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            const meta = CATEGORY_META[key];
            return (
              <section key={key} className="rounded-none border border-[#D4CDC2] bg-[#E8E2D8] p-4">
                <h3 className="font-semibold text-[#1A2138]">{meta.label}</h3>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Third-party services</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Your choices</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">California residents (CCPA)</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Browser controls</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Contact</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
          Questions about cookies:{" "}
          <a href={`mailto:${SITE_EMAIL}`} className="font-semibold text-[#716148] hover:underline">
            {SITE_EMAIL}
          </a>
        </p>
      </PageShell>
