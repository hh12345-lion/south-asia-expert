...
export const metadata = createMetadata({
  title: "South Asia Expert | Asylum Tribunal Reports",
  description:
...
const steps = [
  ...
  },
  {
    ...
    body: "CPR Part 35 and Practice Direction paragraph 10 reports, funding-compatible, typically 2–4 weeks.",
  },
];
...
export default function HomePage() {
  return (
    <>
      ...
      <section className="border-b border-[#D4CDC2] bg-[#F6F4EE]">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-2 lg:items-end lg:gap-16 lg:px-8 lg:py-24">
          <div>
            <p className="kicker">South Asia · tribunals</p>
            <h1 className="font-display mt-4 text-3xl font-semibold leading-[1.15] text-[#1A2138] min-[375px]:text-4xl sm:text-5xl">
          ...
          <div>
            <p className="max-w-lg text-base leading-relaxed text-[#3A4250] sm:text-lg">
              We match counsel with independent expert witnesses for Bangladesh, India, Sri Lanka, Nepal, and
              Bhutan — reports that answer the tribunal&apos;s questions, not a party&apos;s narrative.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href={FORM_HREF}
                className="inline-flex min-h-[48px] items-center justify-center bg-[#716148] px-7 py-3 font-semibold text-white hover:bg-[#1A2138]"
              >
                {BRIEF_CTA}
              </Link>
              <Link
                href={FAQ_HREF}
                className="inline-flex min-h-[48px] items-center justify-center border border-[#1A2138] px-7 py-3 font-semibold text-[#1A2138] hover:bg-[#1A2138] hover:text-white"
              >
                {BRIEF_CTA_HOW}
              </Link>
            </div>
      ...
      <section className="bg-white py-14 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="font-display mt-2 text-2xl font-semibold text-[#1A2138]">Three steps from brief to report</h2>
          <ol className="mt-10 grid gap-8 sm:grid-cols-3">
            {steps.map((step, i) => (
              <li key={step.title} className="border-t-2 border-[#716148] pt-5">
                <p className="text-sm font-semibold text-[#716148]">{i + 1}</p>
                <h3 className="font-display mt-2 text-lg font-semibold text-[#1A2138]">{step.title}</h3>
      ...
      <section className="border-y border-[#D4CDC2] bg-[#E8E2D8] py-14 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <p className="kicker">Why expert evidence</p>
          <h2 className="font-display mt-2 text-2xl font-semibold text-[#1A2138]">
          ...
          <div className="mt-6 max-w-3xl space-y-4 leading-relaxed text-[#3A4250]">
            ...
            <p>
              South Asia Expert is politically neutral. We are not a diaspora organisation, advocacy group, or law firm.
          ...
          <ul className="mt-8 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <li key={item.t} className="border-l-4 border-[#716148] bg-white px-4 py-4">
                <p className="font-display text-sm font-semibold text-[#1A2138]">{item.t}</p>
      ...
      <section className="bg-[#F6F4EE] py-14 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <p className="kicker">Jurisdictions</p>
          <h2 className="font-display mt-2 text-2xl font-semibold text-[#1A2138]">South Asia by country</h2>
          <div className="mt-8 overflow-x-auto">
            <table className="w-full min-w-[36rem] border-collapse text-left text-sm">
              <thead>
                <tr className="border-b border-[#D4CDC2]">
                  <th className="py-3 pr-4 font-semibold text-[#1A2138]">Country</th>
                  <th className="py-3 font-semibold text-[#1A2138]">Focus</th>
                </tr>
              </thead>
              <tbody>
                {countries.map((c) => (
                  <tr key={c.slug} className="border-b border-[#D4CDC2]/80">
                    <td className="py-4 pr-4 align-top font-semibold text-[#1A2138]">{c.title}</td>
      ...
      <section className="bg-white py-14 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="font-display mt-2 text-2xl font-semibold text-[#1A2138]">Key South Asian asylum profiles</h2>
          <p className="mt-3 max-w-2xl text-[#3A4250]">
            High-volume profiles in tribunals: political persecution, religious minorities, LGBTQ claims, and
      ...
      <section className="border-y border-[#D4CDC2] bg-[#E8E2D8] py-14 sm:py-16">
        <div className="mx-auto grid max-w-6xl gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          <div>
            ...
            <h2 className="font-display mt-2 text-2xl font-semibold text-[#1A2138]">Expert witness services</h2>
            <div className="mt-6">
              <CardGrid
          ...
          <div>
            ...
            <h2 className="font-display mt-2 text-2xl font-semibold text-[#1A2138]">Where reports are used</h2>
            <div className="mt-6">
              <CardGrid
      ...
      <section className="bg-[#F6F4EE] py-14 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="font-display mt-3 max-w-2xl text-2xl font-semibold text-[#1A2138] sm:text-3xl">
          ...
          <p className="mt-5 max-w-2xl leading-relaxed text-[#3A4250]">
            ...
            decision-makers materials leave gaps for Bangladesh, India, Nepal, and Bhutan. Expert analysis fills them for
