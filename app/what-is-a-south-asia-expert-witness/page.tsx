...
export const metadata = createMetadata({
  title: "What Is a South Asia Expert Witness? | Immigration Tribunal Role",
  description:
    "A South Asia expert witness provides independent country condition reports for immigration tribunals: Bangladesh politics, India Hindutva, Sri Lanka Tamil, Nepal caste, and Bhutan Lhotshampa analysis.",
  ...
  return (
    <>
      ...
      <PageShell
        ...
        subtitle="The role, duties, and value of independent country expert evidence in South Asian asylum appeals."
        breadcrumbs={crumbs}
      >
        <p className="text-[#3A4250] leading-relaxed">
          ...
          immigration tribunals. Unlike advocates for either party, the expert&apos;s paramount duty is to the
          tribunal: to assist it in reaching a decision by providing unbiased opinion on matters within their expertise.
        </p>

        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">What South Asia Experts Assess</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">When to Instruct a South Asia Expert</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
          Instruct a South Asia expert witness when the decision-makers refusal relies on generic CPIN positions that do not
          ...
          Sri Lanka Tamil claims under KK [2021], and Nepal/Bhutan claims where no country guidance exists.
        </p>

        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Political Neutrality and Regional Balance</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
          South Asia Expert is not aligned with any South Asian government, opposition party, diaspora organisation, or
          advocacy network. The service exists to help counsel obtain impartial country evidence for tribunal
          proceedings, not to promote any country&apos;s interests or any single community&apos;s narrative.
        </p>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
          Country pages and asylum profiles on this site cover the full range of claim types seen in tribunals —
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1A2138]">Report Standards</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <p className="mt-8">
          <Link href="/qualifications" className="font-semibold text-[#716148] hover:underline">
