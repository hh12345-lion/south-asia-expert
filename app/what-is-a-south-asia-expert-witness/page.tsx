  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">What South Asia Experts Assess</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">When to Instruct a South Asia Expert</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">Political Neutrality and Regional Balance</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2541]">Report Standards</h2>
        <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <p className="mt-8">
          <Link href="/qualifications" className="font-semibold text-[#7C6C4F] hover:underline">
