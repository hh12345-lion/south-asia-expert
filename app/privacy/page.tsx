...
export const metadata = createMetadata({
  ...
  description:
    "How South Asia Expert.com collects, uses, and protects personal data from contact form submissions, cookie preferences, and your rights under GDPR.",
  path: "/privacy",
});
  ...
  return (
    <PageShell title="Privacy Policy" breadcrumbs={[{ label: "Home", href: "/" }, { label: "Privacy" }]}>
      <p className="text-[#3A4250] leading-relaxed">
        South Asia Expert.com is operated to connect counsel with qualified South Asia expert witnesses. We collect
      ...
      <p className="mt-4 text-[#3A4250] leading-relaxed">
        ...
        <a href="/cookie-policy" className="font-semibold text-[#716148] hover:underline">
          Cookie Policy
        </a>
        .
      </p>
      <h2 className="mt-8 text-lg font-bold text-[#1A2138]">Your Rights (GDPR)</h2>
      <p className="mt-4 text-[#3A4250] leading-relaxed">
