...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "For Legal Aid cases, obtain LAA prior authority before instruction. Include the expert CV, proposed scope, estimated hours, and fee estimate in your application. South Asia Expert provides LAA-compatible rates for all major South Asian asylum profiles.",
    ],
    faqs: [
      {
